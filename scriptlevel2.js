...
async function mov(e) {
    if (movability == 1) {
        ...
        /* WALK ALL DIRECTIONS */
        if (k == 38 || k == 87) {
            if ((window.bot == 490 && window.lef >= 260 && window.lef <= 480 && unlock == false)|| (window.bot == 490 && window.lef >= 960 && window.lef <= 1180 && unlock2 == false)|| (window.bot==250 && window.lef<=60)) {
        ...
        if (k == 40 || k == 83) {
            if ((window.bot == 710 && window.lef >= 260 && window.lef <= 480 && unlock == false)|| (window.bot == 710 && window.lef >= 960 && window.lef <= 1180 && unlock2 == false)|| (window.bot==370 && window.lef<=60)) {
